...
namespace CNC_Connect.Repositories
{
    public class Repository : IRepository
    {
        ...
        public async Task<HttpResponseWrapper<object>> PostData<T1, T2>(string url, T1 model1, T2 model2)
        {
            var combinedModel = new { Model1 = model1, Model2 = model2 };
            var messageJSON = JsonSerializer.Serialize(combinedModel);
